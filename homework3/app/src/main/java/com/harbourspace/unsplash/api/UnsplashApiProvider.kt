...
class UnsplashApiProvider {
  ...
  fun fetchImages(cb: UnsplashResult) {
    retrofit.fetchPhotoByID().enqueue(object : Callback<UnsplashItemByID> {
      override fun onResponse(
        call: Call<UnsplashItemByID>,
        response: Response<UnsplashItemByID>
      ) {
      ...
      override fun onFailure(call: Call<UnsplashItemByID>, t: Throwable) {
        cb.onDataFetchedFailed()
      }
    })
  }
